...
async def amireallyalive(alive):
    ...
    output = (
        f"**┣•No Alive WithOut Money•┫\n"
        f"   **╭✠╼━━━━━━❖━━━━━━━✠╮**\n"
        f"         **☬ 𝐘𝐀𝐊𝐒𝐀 - 𝐍𝐈𝐇 ☬** \n\n"
        f"   **╰✠╼━━━━━━❖━━━━━━━✠╯**\n"
        f"•➣ 💸 **𝗠𝗮𝘀𝘁𝗲𝗿** :    `{DEFAULTUSER}` \n"
        f"•➣ 👥 **𝗨𝘀𝗲𝗿𝗡𝗮𝗺𝗲** :   @{user.username} \n"
        f"•➣ 💻 **𝗧𝗲𝗹𝗲𝘁𝗵𝗼𝗻** :     `Versi {version.__version__}` \n"
        f"•➣ 🐍 **𝗣𝘆𝘁𝗵𝗼𝗻**    :        `Versi {python_version()}` \n"
        f"•➣ 🌐 **𝗩𝗲𝗿𝘀𝗶 𝗨𝗮𝗻𝗴**:    `{BOT_VER}` \n"
        f"•➣ 🗃️ **𝗠𝗼𝗱𝘂𝗹𝗲**       :       `{len(modules)}` \n\n"
        f"**┏▼━━━━━━━━━━━━━━━━━▼┓**\n"
